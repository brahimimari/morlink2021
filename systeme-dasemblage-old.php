...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<body class="sticky_menu" style="background-image:url(images/body_bg_3.jpg)">
...
<article class="frame_container scale_image_container">
				...
				<figcaption>
					<p class="fw_light">
Nous vous aidons à avoir votre armoire rangée avec de grandes solutions en ferrures de qualité et en 
aménagement d’armoires et de dressings au meilleur prix.
</p>
					<p class="fw_light">
 Nos ferrures pour meubles vous permettent de créer votre armoire et dressing personnalisés, d’optimiser l’espace et les adapter à vos besoins. Vous pourrez économiser beaucoup d’espace avec des portes coulissantes qui vous offrent fonctionnalité et minimalisme, et les accessoires pour l’intérieur des armoires ou des dressings.
							...
							<div class="row t_xs_align_c">
								<div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Visserie.php" class="d_block m_bottom_15">
												<img src="images/produits/sys-asemblage/visserie.jpg" alt="">
											</a>
											<figcaption>
												<a href="Visserie.php" class="second_font sc_hover">Visserie</a>
											</figcaption>
										</figure>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Ferrures-assemblage-pour-meuble.php" class="d_block m_bottom_15">
												<img src="images/produits/sys-asemblage/Ferrures-assemblage-pour-meuble.jpg" alt="">
											</a>
											<figcaption>
												<a href="Ferrures-assemblage-pour-meuble.php" class="second_font sc_hover">Ferrures d'assemblage pour meuble</a>
											</figcaption>
										</figure>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Taquets-et-chevilles.php" class="d_block m_bottom_15">
												<img src="images/produits/sys-asemblage/taquet.jpg" alt="">
											</a>
											<figcaption>
												<a href="Taquets-et-chevilles.php" class="second_font sc_hover">Taquets et chevilles</a>
											</figcaption>
										</figure>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="console.php" class="d_block m_bottom_15">
												<img src="images/produits/sys-asemblage/console.jpg" alt="">
											</a>
											<figcaption>
												<a href="console.php" class="second_font sc_hover">Console</a>
											</figcaption>
										</figure>
									</div>
								</div>
