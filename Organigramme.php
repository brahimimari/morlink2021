...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">	Organigramme </h3>
				...
				<br />
<p class="fw_light">
Pour une gestion centralisée de l’ensemble des clés d’un bâtiment : système de passe partiel  et de passe général.  	</p>
				</figcaption>
			</figure>
