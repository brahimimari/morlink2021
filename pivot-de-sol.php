...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					<a href="index.php" class="sc_hover">Acceuil</a> <span class="color_dark">/</span> 	Pivot de sol	</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Pivot de sol</h2>	
				 <figcaption>
					<p class="fw_light">
Encastré dans le sol et quasiment invisible, le pivot de sol est très efficace.</p>
