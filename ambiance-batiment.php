			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Ambiance</h3>
				 			<div class="flexslider">
								<ul class="slides">
									<li>
									  	<img src="img/ambiance/1.jpg" alt=""></li>
									<li>  	<img src="img/ambiance/2.jpg" alt=""></li>
									<li>  	<img src="img/ambiance/3.jpg" alt=""></li>
									<li>  	<img src="img/ambiance/5.jpg" alt=""></li>
 									<li>  	<img src="img/ambiance/4.jpg" alt=""></li>
...
<p class="fw_light m_bottom_14 p_top_4">
			Morlink vous offre tout un ensemble d’accessoires de haut de gamme pour fixer et mouvementer vos portes, vos menuiseries : des ferrures de construction, de la poignée à la paumelle, du ferme-porte et butoir jusqu'aux serrures …
</p>
<p class="fw_light m_bottom_14 p_top_4">

Avec des produits Häfele, Morlink vous propose des solutions optimales et innovantes, alliant facilité et simplicité à la mise en place et confort et aisance à l’usage.
