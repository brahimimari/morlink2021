...
<html lang="en">
	<head>
		<title>Systèmes d'assemblage</title>
		<meta charset="utf-8">
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					...
					<a href="#" class="sc_hover">Systèmes d'assemblage</a>
					</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/sys-asemblage/15.6_3.png" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
...
<article class="frame_container scale_image_container">
				...
				<figcaption>
					<p class="fw_light">
Dans cette sélection vous trouverez des solutions pour faciliter le montage de vos meubles, aussi bien des ferrures d’assemblage à excentrique intérieure, que des équerres d’assemblage ou même des ferrures pour paroi arrière et assemblage par pression.
