...
<html lang="en">
	<head>
		<title>Rangement pour tiroirs</title>
		<meta charset="utf-8">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Rangement pour tiroirs</h2>	
							</div>
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/cuisine/4.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
						
<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/cuisine/5.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
					</div>
						</div>
				...
				<figcaption>
					<p class="fw_light">
Chez Morlink, vous aurez une variété d’accessoires pour optimiser, avec efficacité et
simplicité, le rangement dans vos tiroirs : des séparateurs et organisateurs qui vous
</p><p class="fw_light">

permettent de compartimenter l’espace disponible, regroupant par nature les objets rangés
et les positionnant en fonction de leur utilisation au quotidien.
</p><p class="fw_light">
Le bon rangement dans vos tiroirs vous fait gagner du temps et vous pousse à maintenir
naturellement le bon ordre après usage : remettre chaque objet utilisé à sa place initialement
définie vous fait éviter l’énervement, ô combien stressant, que l’on vit quand on cherche
dans le désordre.
