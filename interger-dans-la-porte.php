...
<html lang="en">
	<head>
		<title>Ferme porte intégré dans la porte</title>
		<meta charset="utf-8">
...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					<a href="index.php" class="sc_hover">Acceuil</a> <span class="color_dark">/</span> 	Ferme porte intégré dans la porte		</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Ferme porte intégré dans la porte </h2>	
				 <figcaption>
					<p class="fw_light">
Un choix de ferme portes encastrables dans la porte.</p>
							...
							<div class="row t_xs_align_c">
									...
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/ferme-porte/integre a la porte/ferme-porte-interger-5-30.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover"> DCL 97</a><br />
												931.24.100
								...
								<div class="col-lg-4 col-md-4col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/ferme-porte/integre a la porte/ferme-porte-interger-5-31.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover"> DCL 97 FE</a><br />
												931.24.X
								...
								<div class="col-lg-4 col-md-4col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											...
											<figcaption>
												<a href="#" class="second_font sc_hover"> DCL 34</a><br />
												931.84.X
