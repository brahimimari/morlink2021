				...
				<main class="container">
					...
					<div class="box-wrapper">
										<?php
											...
											$sql_menu = 'select * from typevideo';
											$res_typevideo = mysql_query($sql_menu);
											while($data_typevideo = mysql_fetch_array($res_typevideo))
											{
										?>
									 ...
									 <div class="d_table m_bottom_5 w_full animated" data-animation="fadeInDown">
											...
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 t_align_r d_table_cell f_none">
											  ...
											  <?php
												...
												require_once 'pages/Mobile_Detect.php';
												$detect = new Mobile_Detect;
 
												// Any mobile device (phones or tablets).
												if ( $detect->isMobile() ) {
 												   $sql_menu = "select * from video where type= '$type' order by id DESC limit 1 ";
												}
												else
												{	
												$sql_menu = "select * from video where type= '$type' order by id DESC limit 0,4 ";
...
<div data-youcover data-fancybox data-image='https://img.youtube.com/vi/<?php echo utf8_encode($data['video']); ?>/hqdefault.jpg' data-id='<?php echo utf8_encode($data['video']); ?>'></div>
									<h5 style="margin-top:12px"><?php echo utf8_encode($data['titre']); ?></h5>
									</div>	
