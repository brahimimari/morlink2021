...
<html lang="en">
	<head>
		<title>SIB Salon international du Bâtiment Casablanca 2018</title>
		<meta charset="utf-8">
			...
			<div class="page_section_offset">
				<div class="container">
					...
					<main class="col-lg-8 col-md-8 col-sm-8 m_bottom_30 m_xs_bottom_10">
	                        ...
	                        $id = $_GET['id'];
							$sql_menu33 = "select * from infos where id = $id order by id DESC";
	...
	<h2 class="fw_light second_font color_dark tt_uppercase"><?php echo utf8_encode($data33['titre']); ?> </h2>
					...
					<div class="rsContent t_align_r">
						<img class="rsImg" src="images/infos/formationHafele2.jpg" alt="">
					</div>
					<?php } ?>
		
<div class="rsContent t_align_r">
						<img class="rsImg" width="50%" src="images/infos/<?php echo utf8_encode($data33['photo']); ?>" /> 
					</div>
					<!--slide-->
						<!--slide-->
			<!--slide-->
						...
						<div id="can_change_layout" class="category_isotope_container three_columns wrapper m_bottom_10 m_xs_bottom_0" data-isotope-options='{
							...
							include('pages/database.php');
							$idnews = $_GET['id'];
							$sql_menu33 = "select * from infos where id=".intval($idnews);
							$res33 = mysql_query($sql_menu33);
										...
										<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													...
													<p class="fw_light d_none m_bottom_14 color_grey">
													    <p>
														<?php echo utf8_encode($data33['desc']); ?>
