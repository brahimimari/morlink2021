...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Porte pliante </h3>
				 			<div class="flexslider">
								<ul class="slides">
									<li><img src="images/produits/batiment/porte-colissant/pliant/porte-plaint-3.jpg" alt=""></li>
									<li><img src="images/produits/batiment/porte-colissant/pliant/porte-plaint-2.jpg" alt=""></li>
									<li><img src="images/produits/batiment/porte-colissant/pliant/porte-plaint-1.jpg" alt=""></li>
				...
				<br />
<p class="fw_light">
	Porte pliante pour porte en bois <br />
Idéale pour les placards et les pièces plus petites, la porte pliante permet un gain d’espace.


</p>
<p class="fw_light">

	Porte pliante pour porte en verre <br />
En plus du gain d’espace qu’elle permet, la porte pliante en verre apporte esthétique et tonalité personnelle dans votre intérieur.
</p>
					</p>
				</figcaption>
			</figure>
