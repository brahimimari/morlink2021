...
<html lang="en">
	<head>
		<title>Système d'assemblage</title>
		<meta charset="utf-8">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Systèmes d'assemblage</h2>	
							</div>
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/sys-asemblage/1.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
						
<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/sys-asemblage/2.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
				...
				<figcaption>
					<p class="fw_light">
						Morlink vous offre une gamme variée d'éléments pour les systèmes d'assemblage de meubles : des solutions appropriées en ferrures, jonctions excentriques, équerres, amortisseurs, écrous, embouts....
					</p>				
					<p class="fw_light">
						Bien plus, pour tout ce qu'il vous faut pour l'assemblage, le <strong>montage et la fixation </strong>d'étagères, de meubles, et plus généralement <strong>d'aménagements de rangement</strong>, Morlink vous propose un choix de <strong> solutions innovantes et d'éléments de quincaillerie de qualité, en ligne avec votre projet.
					</p>
				</figcaption>
			</figure>
							<div class="row t_xs_align_c">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Systemes-dassemblage-pour-meubles.php" class="d_block m_bottom_15">
												<img src="images/produits/sys-asemblage/Systemes-assemblage-pour-meubles.jpg" alt="">
											</a>
											<figcaption>
												<a href="Systemes-dassemblage-pour-meubles.php" class="second_font sc_hover">Systèmes d'assemblage pour meubles</a>
											</figcaption>
										</figure>
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Supports-et-taquets-detageres.php" class="d_block m_bottom_15">
												<img src="images/produits/sys-asemblage/Supports-et-taquets-etageres.jpg" alt="">
											</a>
											<figcaption>
												<a href="Supports-et-taquets-detageres.php" class="second_font sc_hover">Supports et taquets d'étagères</a>
											</figcaption>
										</figure>
									</div>
								</div>
								
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_30 d_xs_inline_b col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Vis-et-ecrous.php" class="d_block m_bottom_15">
												<img src="images/produits/sys-asemblage/Vis-et-crous.jpg" alt="">
											</a>
											<figcaption>
												<a href="Vis-et-ecrous.php" class="second_font sc_hover">Vis et écrous</a>
											</figcaption>
										</figure>
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_30 d_xs_inline_b col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Amortisseurs-et-bouche-trou.php" class="d_block m_bottom_15">
												<img src="images/produits/sys-asemblage/Amortisseurs-et-bouche-trou.jpg" alt="">
											</a>
											<figcaption>
												<a href="Amortisseurs-et-bouche-trou.php" class="second_font sc_hover">Amortisseurs et bouche trou</a>
											</figcaption>
										</figure>
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 d_xs_inline_b col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Systemes-dassemblage-de-murales.php" class="d_block m_bottom_15">
												<img src="images/produits/sys-asemblage/Systemes-dassemblage-de-murales.jpg" alt="">
											</a>
											<figcaption>
												<a href="Systemes-dassemblage-de-murales.php" class="second_font sc_hover">Systèmes d’assemblage de murales</a>
											</figcaption>
										</figure>
									</div>
								</div>
