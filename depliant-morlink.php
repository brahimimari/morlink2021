...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
	...
	<?php include('pages/header.php'); ?>
		 <div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					<a href="index.php" class="sc_hover">Acceuil</a> / <span class="color_light"><a href="catalogues.php">Catalogues</a></span>/ <span class="color_light">Dépliant</span>
				</div>
			</div>
			<!--main content-->
			<div class="page_section_offset bg_grey_light_2">
				...
				<main class="container">
					<div class="d_table w_full d_xs_block m_bottom_6">
						...
						<br />
							<h3 class="fw_light second_font color_dark second_font color_dark clickable tr_all m_bottom_3 relative" STYLE="font-weight: 400;">Dépliant</h3><hr class="divider_bg m_bottom_30">
						</div>
					...
					<div class="portfolio_isotope_container four_columns wrapper m_bottom_10 m_xs_bottom_0" data-isotope-options='{
						...
						<?php
							...
							$sql_menu33 = "select * from catalogue where type = 2 order by id asc";
						...
						<div class="responsive portfolio_isotope_item living_room" style="">
							<div class="frame_container relative r_image_container db_xs_centered">
								<figure class="relative">
									...
									<figcaption>
										<h5 style="font-size: 13px !important;" class="second_font m_bottom_5 lh_small">
