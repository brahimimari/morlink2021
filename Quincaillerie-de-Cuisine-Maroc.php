...
<html lang="en">
	<head>
		<title>Quincaillerie de Cuisine Maroc</title>
		<meta charset="utf-8">
...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					<a href="index.php" class="sc_hover">Acceuil</a> <span class="color_dark">/</span>	<a href="index.php" class="sc_hover">Produits</a>  
				</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Quincaillerie de Cuisine</h2>	
							</div>
						...
						<div class="row">
							...
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/cuisine/systemederangement/cuisine marin molrink.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc" class="tr_all scale_image"></a>
							</figure>
						</article>
						 ...
						 <?php $i = 1; while($i<=5){ ?>			
								<article class="frame_container scale_image_container">
									<figure class="relative">
										<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/cuisine/<?php echo $i; ?>.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc" class="tr_all scale_image"></a>
									</figure>
								</article>
							<?php $i++;} ?>
				...
				<figcaption>
					...
					Nous mettons à votre disposition des solutions appropriées pour mieux organiser votre espace de cuisine et en profiter pleinement : une <b>quincaillerie de cuisine</b> de haut de gamme pour des <b>meubles de cuisine</b> alliant qualité et fonctionnalité. 
					</p>
					<br />
					<p class="fw_light">
					
					Des <strong>accessoires pour meubles de cuisine</strong> qui vous facilitent le rangement et le stockage des pièces et des produits : une technologie avancée en quincaillerie de cuisine qui vous offre, de manière appropriée, la possibilité de mettre en place, selon vos besoins et vos goûts, un <strong>système de rangement coulissant</strong>, rotatif ou en angle optimisant votre espace de cuisine, <strong>des pieds de table réglables</strong> pour faciliter le déplacement, des <strong>plinthes de cuisine </strong>en matériaux différents alliant utilité au quotidien et décoration à touche personnalisée... 
					
					</p>
				</figcaption>
			</figure>
							<div class="row t_xs_align_c">
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 d_xs_inline_b col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Systeme-de-rangement-pour-cuisine.php" class="d_block m_bottom_15">
												<img src="images/produits/cuisine/Systeme-de-rangement-pour-cuisine.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
											</a>
											<figcaption>
												<a href="Systeme-de-rangement-pour-cuisine.php" class="second_font sc_hover">Systèmes de rangement pour cuisine</a>
											</figcaption>
										</figure>
									</div>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 d_xs_inline_b col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Accessoires-pour-cuisine.php" class="d_block m_bottom_15">
												<img src="images/produits/cuisine/accessoire-pour-cuisine.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
											</a>
											<figcaption>
												<a href="Accessoires-pour-cuisine.php" class="second_font sc_hover">Accessoires pour cuisine</a>
											</figcaption>
										</figure>
									</div>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 d_xs_inline_b col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="pied-plinthes-de-cuisine.php" class="d_block m_bottom_15">
												<img src="images/produits/cuisine/pied-et-plithes.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
											</a>
											<figcaption>
												<a href="pied-plinthes-de-cuisine.php" class="second_font sc_hover">Pieds et plinthes de cuisine</a>
											</figcaption>
										</figure>
									</div>
								</div>
			...
			<div class="popup init">
				<div class="clearfix m_bottom_15">
					<a href="#" class="f_left d_block m_right_20">
						<img src="images/bestsellers_img_1.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
					</a>
				...
				<div class="clearfix">
					<div class="product_preview f_left f_xs_none wrapper m_xs_bottom_15">
						<div class="d_block relative r_image_container">
							<img id="zoom" src="images/product_img_0.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc" data-zoom-image="images/p_image1.jpg">
						...
						<div class="product_thumbnails_wrap relative m_bottom_3">
							<div class="owl-carousel" id="thumbnails" data-nav="thumbnails_product_" data-owl-carousel-options='{
								...
								<a href="#" data-image="images/product_img_0.jpg" data-zoom-image="images/p_image1.jpg" class="d_block">
									<img src="images/product_thumb_1.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
								<a href="#" data-image="images/product_img_1.jpg" data-zoom-image="images/p_image2.jpg" class="d_block">
									<img src="images/product_thumb_2.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
								<a href="#" data-image="images/product_img_2.jpg" data-zoom-image="images/p_image3.jpg" class="d_block">
									<img src="images/product_thumb_3.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
								<a href="#" data-image="images/product_img_3.jpg" data-zoom-image="images/p_image4.jpg" class="d_block">
									<img src="images/product_thumb_4.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
								<a href="#" data-image="images/product_img_6.jpg" data-zoom-image="images/p_image7.jpg" class="d_block">
									<img src="images/product_thumb_5.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
								<a href="#" data-image="images/product_img_9.jpg" data-zoom-image="images/p_image10.jpg" class="d_block">
									<img src="images/product_thumb_6.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
								<a href="#" data-image="images/product_img_4.jpg" data-zoom-image="images/p_image5.jpg" class="d_block">
									<img src="images/product_thumb_7.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
								<a href="#" data-image="images/product_img_7.jpg" data-zoom-image="images/p_image8.jpg" class="d_block">
									<img src="images/product_thumb_8.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
								<a href="#" data-image="images/product_img_5.jpg" data-zoom-image="images/p_image6.jpg" class="d_block">
									<img src="images/product_thumb_9.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
								<a href="#" data-image="images/product_img_8.jpg" data-zoom-image="images/p_image9.jpg" class="d_block">
									<img src="images/product_thumb_10.jpg" alt="quincaillerie de cuisine maroc" title="quincaillerie de cuisine maroc">
								</a>
							</div>
