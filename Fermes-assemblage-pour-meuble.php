...
<html lang="en">
	<head>
		<title>Fermes d'assemblage pour meuble</title>
		<meta charset="utf-8">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Ferrures d’assemblage pour meubles </h2>	
							</div>
...
<article class="frame_container scale_image_container">
				...
				<figcaption>
					<p class="fw_light">
Nous proposons des solutions en ferrures aux fabricants et à l’industrie du meuble, grâce 
à notre très large gamme d’éléments comme nos ferrures d’assemblage, excentriques, équerres d’assemblage, embouts, clés Allen, écrous, amortisseurs… 
tout ce dont vous avez besoin pour le montage de toute sorte de meubles.
