...
<html lang="en">
	<head>
		<title>Ferrures et accessoires pour la cuisine</title>
		<meta charset="utf-8">
...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					<a href="index.php" class="sc_hover">Acceuil</a> <span class="color_dark">/</span>Ferrures et accessoires pour la cuisine</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Ferrures et accessoires pour la cuisine</h3>
				 			<div class="flexslider">
								<ul class="slides">
									<li>
									  	<img src="images/produits/meuble/cuisine/meuble-de-cuisine-morlink.jpg" alt=""></li>
									  	<li><img src="images/produits/meuble/cuisine/meuble-de-cuisine-morlink-casablanca.jpg" alt=""></li>
								</ul>
							</div>
				<figcaption>
				<br />
<p class="fw_light m_bottom_14 p_top_4">
Vivez tout l’espace disponible dans votre cuisine, grâce à des solutions innovantes, optimisant les  parties dédiées au stockage et améliorant l’aménagement de l’intérieur : range-couverts pour tiroirs, porte-vaisselle, plinthes, angles, rallonges, accessoires pour les plans de travail de la cuisine…
	</p>
					</p>
				</figcaption>
			</figure>
