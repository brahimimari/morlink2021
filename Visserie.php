		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					...
					<a href="#" class="sc_hover">Visserie</a>
					</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Visserie</h2>	
							</div>
...
<article class="frame_container scale_image_container">
				...
				<figcaption>
					<p class="fw_light">
Un large assortiment de vis sont prévues pour les fixations sur toutes sortes de matériaux, comme le bois, le métal, le plastique. Les vis sont disponibles dans différents types de filetage comme métriques, non-métriques, auto-taraudeuses et pour le bois. On vous propose des vis dans toutes variantes de tête possibles comme vis à tête fraisée, vis à tôle à tête cylindrique bombée, vis à oreilles, vis à tête cylindrique, vis à tête fraisée bombée.
