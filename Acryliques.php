			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Acryliques</h2>	
							</div>
...
<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/poignees/acryliques1.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
				...
				<figcaption>
					<p class="fw_light">
Les Acryliques de tiroirs de cuisine sont de petits détails qui ont un grand impact sur le style de votre décoration de cuisine. Ils sont faciles à remplacer, quand vous voulez vous  pour offrir un relooking éclair à votre cuisine.
</p>
				<p class="fw_light">

				Nous vous offrons un large éventail d’acryliques pouvant s'harmoniser avec vos goûts.
