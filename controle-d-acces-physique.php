...
<html lang="en">
	<head>
		<title>Contrôle d'accès physique  </title>
		<meta charset="utf-8">
...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Contrôle d'accès physique </h3>
				...
				<br />
<p class="fw_light">
Pour gérer et maîtriser les accès physiques à un espace prédéfini.					</p>
				</figcaption>
			</figure>
