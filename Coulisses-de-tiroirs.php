			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Titoires de côtés</h2>	
							</div>
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/tiroires/1.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
				...
				<figcaption>
					<p class="fw_light">
Différentes sortes de coulisses vous sont proposées pour faire glisser sur rails vos tiroirs,
afin de vous permettre d’accéder facilement à ce qu’ils contiennent ou de les repousser,
aussi facilement, pour les fermer : coulisses push, coulisses à extraction totale ou partielle,
des glissières à bille avec ou sans frein, des glissières à galets…
</p>
					<p class="fw_light">
Morlink vous offre toute une variété de coulisses de tiroirs, avec la possibilité d’un système
de piston régulateur qui assure un mouvement en douceur et une fin de course amortie.
Faciles d’installation, les modèles de coulisses de tiroirs que vous choisirez dépendront à la
fois de la profondeur de vos tiroirs et de la charge qu’ils auront à supporter.
</p>
					<p class="fw_light">

Morlink vous propose aussi des ferrures de qualité, des modèles de dimensions et de
largeurs différentes, permettant de réaliser des tiroirs, des armoires et des dressings
personnalisés, fonctionnels, bien optimisant l'espace et résistants à l’usage.
					</p>
				</figcaption>
			</figure>
						 	</main>
