...
<html lang="en">
	<head>
		<title>Supports et taquets d'étagères</title>
		<meta charset="utf-8">
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					...
					<a href="#" class="sc_hover">Supports et taquets d'étagères</a>
					</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-8 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Supports et taquets d'étagères</h2>	
							</div>
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/sys-asemblage/support-et-taquets-pour-etagers.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
				...
				<figcaption>
					<p class="fw_light">
Efficacité, robustesse et durabilité caractérisent les supports et taquets d'étagères que
nous vous proposons.
</p>
					<p class="fw_light">

Morlink met à votre disposition un large choix de supports et taquets d'étagères avec des
styles variés, pouvant s'agencer avec différentes épaisseurs et présenter les niveaux de
résistance de charge nécessaires.
