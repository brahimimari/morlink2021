...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		</style><script src="js/modernizr.js"></script>
	</head>
		...
		<div class="db_centered bg_white">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
				...
				<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Contrôle d’accès</h2>
				 
				<figcaption>
					<p class="fw_light">
Pour sécuriser votre bâtiment, nous vous proposons des systèmes de <strong>contrôle d’accès </strong> physique permettant de gérer les accès physiques à l’espace prédéfini, de manière assurant l’efficacité nécessaire et traçabilité voulue.
					</p>
					
					<p class="fw_light">

Dans ce cadre, vous pouvez choisir la solution qui convient à vos besoins ; la <strong> serrure de porte </strong> standard s’adaptant à vos exigences individuelles, le <strong> système de fermeture </strong> électronique assurant une gestion personnalisée et fiable des <strong>points d’accès </strong>… 
							...
							<div class="row t_xs_align_c">
									...
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/controle acces/controle-dacces-1.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">DT 710 Door terminal set </a>
											</figcaption>
										</figure>
									</div>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/controle acces/controle-dacces-2.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">PinLock Combination lock </a>
											</figcaption>
										</figure>
									</div>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/controle acces/controle-dacces-3.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">Electronic cam lock miniLock </a>
											</figcaption>
										</figure>
									</div>
								</div>
