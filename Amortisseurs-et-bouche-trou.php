...
<html lang="en">
	<head>
		<title>Amortisseurs et bouche trou</title>
		<meta charset="utf-8">
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					...
					<a href="#" class="sc_hover">Amortisseurs et Cache vis</a>
					</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Amortisseurs et Cache vis</h2>	
							</div>
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/sys-asemblage/Amortisseurs-et-bouche-trou2.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
				...
				<figcaption>
					<p class="fw_light">
Pour un meilleur confort sonore dans vos espaces intérieurs de vie, Morlink vous offre la
possibilité d'y aménager une variété d’amortisseurs.
</p>
					<p class="fw_light">

De même, pour marquer davantage votre style personnel dans vos espaces intérieurs de
vie, Morlink vous propose des Cache Vis (caches adhésifs) pour dissimuler les têtes des vis
: une variété de finitions sont proposées pour être en harmonie avec les différents
meubles.
