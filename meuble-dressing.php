...
<html lang="en">
	<head>
		<title>Ferrures et accessoires pour le dressing</title>
		<meta charset="utf-8">
...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					<a href="index.php" class="sc_hover">Acceuil</a> <span class="color_dark">/</span>Ferrures et accessoires pour le dressing</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Ferrures et accessoires pour le dressing</h3>
				 			<div class="flexslider">
								<ul class="slides">
									<li>
									  	<img src="images/produits/meuble/dressing/meuble-de-dressing-hafele.jpg" alt=""></li>
									  <li>	<img src="images/produits/meuble/dressing/meuble-de-dressing-morlink-hafele.jpg" alt=""></li>
...
<p class="fw_light m_bottom_14 p_top_4">
								Donnez un air moderne à votre dressing et profitez d’un grand confort à l’usage, en optant pour des systèmes coulissants, avec possibilité d’ouverture et fermeture amortie, et des accessoires stylés et adaptables, conçus pour des combinaisons pratiques et fonctionnelles de l’espace disponible : porte-pantalons, porte-cravates et ceintures, penderie rabattable, porte-cintres, range-chaussures, système d’éclairage LED…
</p>
<p class="fw_light m_bottom_14 p_top_4">

Dans ce cadre, Morlink vous offre un large choix de produits de design haut de gamme, venez en profiter !
