...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">CHARNIÈRES ET FERMETURE</h3>
				 			<div class="flexslider">
								<ul class="slides">
									<li>	<img src="images/produits/charniere/char1.jpg" alt=""></li>
				...
				<br />
<p class="fw_light">
Nous vous offrons les meilleurs ferrures et accessoires pour meubles, comme les charnières, compas et fermetures pour répondre à tous vos besoins.  
</p>
<p class="fw_light">
Les solutions que nous proposons sont faciles à installer et apportent un plus de confort pour vous rendre la vie plus facile.
</p>
					</p>
				</figcaption>
			</figure>
							<div class="row t_xs_align_c">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Relevants.php" class="d_block m_bottom_15">
												<img src="images/categorie/relevants.jpg" alt="">
											</a>
											<figcaption>
												<a href="Relevants.php" class="second_font sc_hover">Relevants</a>
											</figcaption>
										</figure>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6  col-xs-6">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="Charnieres.php" class="d_block m_bottom_15">
												<img src="images/categorie/charniere-1.jpg" alt="">
											</a>
											<figcaption>
												<a href="Charnieres.php" class="second_font sc_hover">Charnières</a>
											</figcaption>
										</figure>
									</div>
								</div>
