...
<html lang="en">
	<head>
		<title>Fermeture pour armoires et dressing</title>
		<meta charset="utf-8">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-8 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Fermeture pour armoires et dressing</h2>	
							</div>
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/q-cuisine/Fermeture-pour-armoire.png" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
				...
				<figcaption>
					<p class="fw_light">
Nous vous proposons des solutions innovantes en <strong>ferrures pour meubles </strong> pour la concrétisation de votre projet d’armoire et de <strong>dressing </strong> en pleine harmonie avec vos besoins et votre imagination.
</p>
<p class="fw_light">

Toute une multitude de types de <strong> ferrures pour armoires et dressing</strong>, de <strong>haut de gamme</strong>, apportant fonctionnalité et élégance aux mouvements de vos <strong>portes coulissantes</strong>, au positionnement de vos étagères et cloisons…   
