...
<html lang="en">
	<head>
		<title>Systèmes d'assemblage pour étagères</title>
		<meta charset="utf-8">
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					...
					<a href="#" class="sc_hover">Systèmes d'assemblage pour étagères</a>
					</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Systèmes d'assemblage pour étagères</h2>	
							</div>
...
<article class="frame_container scale_image_container">
				...
				<figcaption>
					<p class="fw_light">
Plusieurs solutions avec systèmes d’assemblage pour meubles à étagères, qui permettent de les installer facilement, sans même besoin d’outils. La fixation de l’étagère est alors invisible, stable et fiable.
