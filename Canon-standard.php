...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Canon standard   </h3>
				 			 
				<figcaption>
				<br />
<p class="fw_light">
Un choix de canons standard pour répondre à vos besoins courants. 
						...
						<div class="row t_xs_align_c">
									...
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/systeme de fermeture/canon/Canon-1.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">Double cylinder</a>
											</figcaption>
										</figure>
									</div>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/systeme de fermeture/canon/Canon-2.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">Thumbturn cylinder  </a>
											</figcaption>
										</figure>
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/systeme de fermeture/canon/Canon-3.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">Double cylinder  </a>
											</figcaption>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/systeme de fermeture/canon/Canon-4.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">Thumbturn cylinder  </a>
											</figcaption>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/systeme de fermeture/canon/Canon-5.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">Single cylinder  </a>
											</figcaption>
										</figure>
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/systeme de fermeture/canon/Canon-6.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">WC Thumbturn cylinder  </a>
											</figcaption>
										</figure>
									</div>
								</div>
