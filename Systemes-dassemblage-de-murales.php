...
<html lang="en">
	<head>
		<title>Systèmes d’assemblage de murales</title>
		<meta charset="utf-8">
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					...
					<a href="#" class="sc_hover">Systèmes d’assemblage de murales</a>
					</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Systèmes d’assemblage de murales</h2>	
							</div>
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/sys-asemblage/system-assemblage-murales.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>		 
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/sys-asemblage/system-assemblage-murales1.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
						 			 </div>
						</div>
				...
				<figcaption>
					<p class="fw_light">
Morlink vous offre des systèmes d'assemblage de meubles au mur, pratiques et efficaces,
visibles ou invisibles, selon vos choix.
</p>
<p class="fw_light">

Des ferrures de qualité vous permettent de suspendre, en toute sécurité et toute facilité
d'usage, vos caissons en hauteur, utilisant au mieux vos espaces intérieurs de vie.
