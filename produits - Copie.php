...
$(function() { 
 $('html, body').animate({
    scrollTop: $('#brahim').offset().top}, 1000);
}); 
</script>
		...
		<div class="db_centered bg_white">
			...
			<![endif]-->
				<?php include('pages/header.php'); ?>
							...
							?>
			 <!--breadcrumbs-->
			<div id="brahim" class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					...
					<div class="flexslider">
								<ul class="slides">
									<?php 
										$dir = 'images/animation/'.$id_categ.'/*.{jpg,jpeg,gif,png}';
									...
									<div class="frame_container relative">
										<figure class="relative">
											<a href="famille.php?id=<?php echo $data_fa['id']; ?>&id_categ=<?php echo $id_categ; ?>" class="d_block m_bottom_15">
												<img src="images/categorie/relevants.jpg" alt="">
											</a>
											<figcaption>
												<a href="famille.php?id=<?php echo $data_fa['id']; ?>&id_categ=<?php echo $id_categ; ?>" class="second_font sc_hover"><?php echo utf8_encode($data_fa['famille']); ?></a>
											</figcaption>
										</figure>
									</div>
								</div>
