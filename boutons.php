			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Boutons</h2>	
							</div>
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/poignees/1.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
					 >
				...
				<figcaption>
					<p class="fw_light">
Les boutons de tiroirs de cuisine sont pour vos meubles de cuisine, ce que sont les épices pour les plats que vous cuisinez : ils donnent l’apparence de vos meubles et la signature de votre style… Pour donner un relooking éclair à votre cuisine quand vous voulez, vous pouvez ne remplacer que les boutons de vos meubles de cuisine.
</p>
					<p class="fw_light">

Morlink vous propose un large choix de boutons pouvant s'harmoniser avec vos goûts.
