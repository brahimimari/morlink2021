									...
									<li class="relative"><a class="fs_large_0 d_inline_b tr_delay" href="<?php echo ($data['categorie']); ?>-<?php echo $data['id']; ?>.html"><?php echo ($data['categorie']); ?></a><button class="open_sub_categories fs_medium"></button>
										...
										<ul class="d_none">
											...
											error_reporting(0);
												...
												{
												?>
											<li style="margin-left:8px;" class="relative"><a href="<?php echo ($data2['famille']); ?>-<?php echo $data2['id']; ?>-<?php echo $id_categ; ?>.html" class="tr_delay d_inline_b">- <?php echo ($data2['famille']); ?></a></li>
											<?php }?>
										</ul>
									</li>
									 <?php } ?>
