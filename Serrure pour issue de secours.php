...
<html lang="en">
	<head>
		<title>Serrure pour issue de secours</title>
		<meta charset="utf-8">
...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Serrure pour issue de secours </h3>
...
Un choix de serrures pour issues de secours, avec système anti-panique 
		</p>
				</figcaption>
			</figure>
