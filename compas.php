			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Compas</h2>	
							</div>
...
<article class="frame_container scale_image_container">
				...
				<figcaption>
					<p class="fw_light">
					Nous disposons d’une grande variété de compas à fonctionnement optimal, conçus pour vos portes avec des solutions efficaces pour profiter au maximum de l’espace utile et pour faciliter l’accès à vos meubles de cuisine, de salle de bain et de la maison en général.
					</p>
				</figcaption>
			</figure>
