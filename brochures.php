...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
	...
	<?php include('pages/header.php'); ?>
		 <div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					<a href="index.php" class="sc_hover">Acceuil</a> / <span class="color_light"><a href="catalogues.php">Catalogues</a></span>/ <span class="color_light">Brochures</span>
				</div>
			</div>
			<!--main content-->
			<div class="bg_grey_light_2 page_section_offset">
			 	<main class="container">
					<div class="d_table w_full d_xs_block m_bottom_6">
						...
						<br />
							<h3 class="fw_light second_font color_dark second_font color_dark clickable tr_all m_bottom_3 relative" STYLE="font-weight: 400;">Catalogues de nos fournisseurs</h3><hr class="divider_bg m_bottom_30">
						</div>
					...
					<div class="portfolio_isotope_container four_columns wrapper m_bottom_10 m_xs_bottom_0" data-isotope-options='{
						...
						<?php
							...
							$sql_menu33 = "select * from catalogue where type = '1' order by id desc";
