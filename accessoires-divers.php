...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					<a href="index.php" class="sc_hover">Acceuil</a> <span class="color_dark">/</span> Accessoires divers	</div>
			</div>
			<!--main content-->
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Accessoires divers </h2>	
				 <figcaption>
					<p class="fw_light">
Un choix d’accessoires divers pour le bon fonctionnement de vos portes.</p>
							...
							<div class="row t_xs_align_c">
									...
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/ferme-porte/apparent/apparent-5.8-1.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover"> DCL 11, DCL 12</a><br />
												931.84.X
								 ...
								 <div class="col-lg-4 col-md-4col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/ferme-porte/apparent/apparent-5.10-1.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover"> DCL 80</a><br />
												931.26.X
								 ...
								 <div class="col-lg-4 col-md-4col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/ferme-porte/apparent/apparent-5.12-1.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">DCL 15, DCL 16</a><br />
												931.84.X
								 ...
								 <div class="col-lg-4 col-md-4col-sm-4 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											<a href="#" class="d_block m_bottom_15">
												<img src="images/produits/batiment/ferme-porte/apparent/apparent-5.16-1.jpg" alt="">
											</a>
											<figcaption>
												<a href="#" class="second_font sc_hover">DCL 61</a><br />
												931.84.X
