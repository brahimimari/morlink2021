...
<html lang="en">
	<head>
		<title>contrôle d'accès logique  </title>
		<meta charset="utf-8">
...
<?php include('pages/referencement.php') ?>		<!--include favicon-->
		...
		<div class="db_centered bg_white">
			...
			<figure class="m_bottom_45 m_xs_bottom_30">
					<h3 class="fw_light second_font color_dark tt_uppercase m_bottom_27">contrôle d'accès logique </h3>
				...
				<br />
<p class="fw_light">
A la fois simple et facile à mettre en place ! Un système sûr et  flexible pour gérer la sécurité d’accès à une enceinte.					</p>
				</figcaption>
			</figure>
