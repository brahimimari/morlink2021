			...
			<figure class="m_bottom_45 m_xs_bottom_30">
						...
						<div class="d_table m_bottom_5 w_full animated hidden" data-animation="fadeInDown" data-animation-delay="500">
							<div class="col-lg-6 col-md-8 col-sm-6 col-xs-8 v_align_m d_table_cell f_none">
								<h2 class="fw_light second_font color_dark tt_uppercase m_bottom_27">Système de rangement pour cuisine</h2>	
							</div>
						...
						<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/dressing1.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
						
<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/dressing2.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
						
<article class="frame_container scale_image_container">
							<figure class="relative">
								<a href="#" class="d_block wrapper m_bottom_15"><img src="images/produits/dressing3.jpg" alt="" class="tr_all scale_image"></a>
							</figure>
						</article>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											...
											<figcaption>
												<a href="#" class="second_font sc_hover">Fermeture pour armoires et dressing</a>
											</figcaption>
										</figure>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_xs_bottom_30 f_xs_none d_xs_inline_b">
									<div class="frame_container relative">
										<figure class="relative">
											...
											<figcaption>
												<a href="#" class="second_font sc_hover">Accessoires de dressing</a>
											</figcaption>
										</figure>
									</div>
								</div>
